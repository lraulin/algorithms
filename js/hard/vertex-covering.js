 ...
 * the graph such that every edge is incident to at least one vertex in the 
 * set. 
 * 
 ...
 * the string yes. But, if for example the last part of the array was (C,B) 
 * then these vertices don't cover all the edges because the edge connecting 
