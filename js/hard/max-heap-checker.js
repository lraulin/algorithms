/**
 * Challenge 
 * Using the JavaScript language, have the function MaxHeapChecker(arr) take 
 * arr which represents a heap data structure and determine whether or not it 
 * is a max heap. A max heap has the property that all nodes in the heap are 
 * either greater than or equal to each of its children. For example: if arr is 
