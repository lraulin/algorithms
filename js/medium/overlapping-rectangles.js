 ...
 * rectangle. For the above example, the overlapping region makes up a 
 * rectangle of area 2, and the first rectangle (the first 4 coordinates) makes 
 * up a rectangle of area 4, so your program should output 2. The coordinates 
 * will all be integers. If there's no overlap between the two rectangles 
 * return 0. 
 * Sample Test Cases 
